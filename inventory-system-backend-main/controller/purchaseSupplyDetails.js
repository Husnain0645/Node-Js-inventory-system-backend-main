...
const purchaseSupplyDetails = require("../models/Purchase_Supply_Details");


// ////////////////////////////////////////////add purchase supply detail  //////////////////////////////////////////////////
exports.purchaseSupplyDetails = async (req , res ) => {

    
    try {
        const { suggestedBoxes, quantity , orderBoxQty , purchaseSupplyId , productId , companyId  } = req.body;
        // 
        //  const category = await Category.findOne({where :{id : CategoryId}})
          var newproduct = await purchaseSupplyDetails.create({
            suggestedBoxes, quantity , orderBoxQty , purchaseSupplyId , productId , companyId })
            .then(()=>{
              res.json({
                message : "Success"
              })
