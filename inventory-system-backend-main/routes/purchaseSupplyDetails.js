...
const purchaseSupplyDetails = require("../controller/purchaseSupplyDetails");
var {
    passport,
    authAdmin,
    authManager,
...
//add supply details  
router.post(
    "/addNew", passport.authenticate("jwt", { session: false }) ,purchaseSupplyDetails.purchaseSupplyDetails
  );
